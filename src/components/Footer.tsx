...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'DOOPINET',
      href: 'https://web.doopinet.com/?dref=doojobs',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              ...
              Spécialisé en Spring Boot, Laravel, React & React Native avec une expertise 
              en microservices et intelligence artificielle.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Accueil', 'À propos', 'Compétences', 'Expérience', 'Projets', 'Contact'].map((item, index) => (
                <li key={index}>
                  <button
                    onClick={() => document.querySelector(`#${item.toLowerCase().replace('à ', '').replace(' ', '')}`)?.scrollIntoView({ behavior: 'smooth' })}
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Rince Donfack. Tous droits réservés.
            </p>
